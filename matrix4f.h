...
class Matrix4f {
	...
	{
		std::cout<<"====================================="<<std::endl;
		std::cout<<_item[0][0]<< "\t|\t" <<_item[0][1]<< "\t|\t" <<_item[0][2]<< "\t|\t" <<_item[0][3]<< "\t|\t" <<std::endl;
		std::cout<<_item[1][0]<< "\t|\t" <<_item[1][1]<< "\t|\t" <<_item[1][2]<< "\t|\t" <<_item[1][3]<< "\t|\t" <<std::endl;
		std::cout<<_item[2][0]<< "\t|\t" <<_item[2][1]<< "\t|\t" <<_item[2][2]<< "\t|\t" <<_item[2][3]<< "\t|\t" <<std::endl;
		std::cout<<_item[3][0]<< "\t|\t" <<_item[3][1]<< "\t|\t" <<_item[3][2]<< "\t|\t" <<_item[3][3]<< "\t|\t" <<std::endl;
		std::cout<<"====================================="<<std::endl;
	}
